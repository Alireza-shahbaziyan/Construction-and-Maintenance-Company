<template>
    <div>
        ...
        <swiper-slide><img src="../assets/images/Slider/slide1.jpg" /><div class="p-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. In, inventore.</div></swiper-slide>

...
<footer class="bg-zinc-800">
    ...
    <div class="px-4 py-6 bg-zinc-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-zinc-400  sm:text-center">© 2024 <a href="https://flowbite.com/">All Angle Solutions™</a>
        </span>
